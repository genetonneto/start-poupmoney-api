package com.web.start.poupmoney.api.poupmoney.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleDataException(
            ...
            WebRequest request) {
        log.error("Failed to save entity with associated data", dataException);
        return buildErrorResponse(
                dataException,
                HttpStatus.CONFLICT,
                request);
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        ErrorResponse errorResponse = new ErrorResponse(status, "Email ou senha invalido");
